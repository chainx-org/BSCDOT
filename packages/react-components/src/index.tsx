...
export { default as Icon } from '@polkadot/pages/components/Icon';
...
export { default as Spinner } from '@polkadot/pages/components/Spinner';
...
export { default as Status, StatusContext } from '../../pages/src/components/Status';
